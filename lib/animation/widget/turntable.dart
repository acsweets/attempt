...
class BaGuaController {
  ...
  BaGuaController({this.direction = Direction.up,this.onEnd,this.onStart});
    ...
    return GestureDetector(
      ...
      onPanEnd: (details) {
        ...
        final double velocity =
            under * details.velocity.pixelsPerSecond.dx * 0.001;
      ...
      child: Transform.rotate(
        ...
        child: BaGuaWheel(
            size: widget.size, direction: widget.controller.direction),
      ),
    );
  }
}
...
class BaGuaWheel extends StatelessWidget {
  ...
  const BaGuaWheel({super.key, required this.size, required this.direction});
